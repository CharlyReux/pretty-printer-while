...
import pret.generator.MyDslGenerator;
...
public class MyDelegateGenerator extends GeneratorDelegate {
	...
	public void generate(Resource input, IFileSystemAccess2 fsa, IGeneratorContext context,int mainId, int ifInd,
			int whInd, int forInd, int foreInd,int elInd,String outFile) {
		try {
			beforeGenerate(input, fsa, context);
			generator.doGeneratIndent(input, fsa, context, mainId, ifInd, whInd, forInd, foreInd,elInd,outFile);
		} finally {
