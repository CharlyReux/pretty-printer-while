...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_EBlist(ISerializationContext context, EBlist semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.EBLIST__LE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.EBLIST__LE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEBlistAccess().getLeLExprParserRuleCall_2_0(), semanticObject.getLe());
		feeder.finish();
	}
	...
	protected void sequence_EBsy(ISerializationContext context, EBsy semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.EBSY__SY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.EBSY__SY));
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.EBSY__LE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.EBSY__LE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEBsyAccess().getSySYMBOLTerminalRuleCall_1_0(), semanticObject.getSy());
		feeder.accept(grammarAccess.getEBsyAccess().getLeLExprParserRuleCall_2_0(), semanticObject.getLe());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (exp=Expression focom=Commands)
	 */
	protected void sequence_For(ISerializationContext context, For semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.FOR__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.FOR__EXP));
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getForAccess().getExpExpressionParserRuleCall_1_0(), semanticObject.getExp());
	 ...
	 *
	 * Constraint:
	 *     (forevar=VARIABLE exp=Expression forecom=Commands)
	 */
	protected void sequence_Foreach(ISerializationContext context, Foreach semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.FOREACH__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.FOREACH__EXP));
		...
		feeder.accept(grammarAccess.getForeachAccess().getExpExpressionParserRuleCall_3_0(), semanticObject.getExp());
	 ...
	 *
	 * Constraint:
	 *     (exp=Expression iflc=Commands ellc=Commands?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (exp=Expression whcom=Commands)
	 */
	protected void sequence_While(ISerializationContext context, While semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.WHILE__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.WHILE__EXP));
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getWhileAccess().getExpExpressionParserRuleCall_1_0(), semanticObject.getExp());
